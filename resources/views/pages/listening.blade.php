...
<section class="section-library pb-5" style="background-color : #f4f6f8">
    <div class="container-fluid">
        ...
        <div class="container pt-4">
            <h3 class="text-uppercase">Thư viện nghe - Listening</h3>
            ...
            <div class="book-library">
                ...
                <div class="content-book">
                    <div class="content-content-book">
                        <h4>Sách IELTS Writing Task 2 2019</h4>
                        <span>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Adipisci tempora ipsam
                            doloremque, excepturi est exercitationem impedit corrupti natus placeat odit maxime
                            obcaecati. Dignissimos explicabo voluptatem repudiandae aut ut molestiae sint!</span>
                        <a href="" class="btn btn-danger book-button">Đọc tiếp</a>
                    </div>
                </div>
            </div>
            <div class="book-library">
