...
@section('title')
    Thêm thể loai thư viện
@endsection
@section('content')

    <section class="content-header">
        <h1>
            Thêm thể loại thư viện
        </h1>
        <ol class="breadcrumb">
            <li><a href=""><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Thêm thể loại thư viện</li>
        </ol>
    </section>
    <br>
    <div>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="box box-primary">
                    <h3 style="text-align: left; padding-left: 5px">Thêm thể loại thư viện</h3>
                    <form role="form" method="POST" action="{{route('cate_library.store')}}"
                                    ...
                                    <td>
                                        ...
                                        <div>
                                            ...
                                            <a class="btn btn-danger"
                                               ...
                                               onclick="return confirm('Hành động sẽ xóa thể loại thư viện này! bạn có muốn tiếp tục?')">Xóa</a>
                                            @if($value->status==1)
                                                <a class="btn btn-info"
                                                   href="{{ url('admin/library/setactive-cate/'.$value->id.'/0') }}"
                                                   onclick="return confirm('Hành động sẽ ẩn thể loại thư viện này! bạn có muốn tiếp tục?')">Ẩn</a>
                                            @else
                                                <a class="btn btn-warning"
                                                   href="{{ url('admin/library/setactive-cate/'.$value->id.'/1') }}"
                                                   onclick="return confirm('Hành động sẽ hiển thị thể loại thư viện mục này! bạn có muốn tiếp tục?')">Hiển
                                                    thị</a>
