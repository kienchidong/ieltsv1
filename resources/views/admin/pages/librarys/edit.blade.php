...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Sửa thư viện</li>
        </ol>
    </section>
    <br>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="box box-primary">
                    ...
                    <form role="form" method="POST" action="{{route('library.update',$library->id)}}"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                        <textarea name="summary" rows="4" placeholder="Nhập tóm tắt"
                                                  class="form-control">{{ $library->summary }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="box-footer">
                                <a href="{{route('library.index')}}" class="btn btn-warning">Quay lại</a>
