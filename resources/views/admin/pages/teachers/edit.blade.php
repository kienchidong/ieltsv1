        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="box box-primary">
                    <h3 style="text-align: left; padding-left: 5px">Sửa giáo viên</h3>
                    <form role="form" method="POST" action="{{route('teacher.update',$teacher->id)}}"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div id="viewImg">
                                    <img width="100px" height="150px" src="{{asset('')}}images/teachers/{{$teacher->image}}">
                                </div>
                            </div>
                            ...
                            <div class="box-footer">
                                <a href="{{route('teacher.index')}}" class="btn btn-warning">Quay lại</a>
