        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="box box-primary">
                    <h3 style="text-align: left; padding-left: 5px">Sửa khóa học đang tuyển </h3>
                    <form role="form" method="POST" action="{{route('course_enrolling.update',$course_enrolling->id)}}"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div id="viewImg">
                                    <img width="100px" height="150px" src="{{asset('')}}images/course_enrolling/{{$course_enrolling->image}}">
                                </div>
                            </div>

                            <div class="box-footer">
                                <a href="{{route('course_enrolling.index')}}" class="btn btn-warning">Quay lại</a>
