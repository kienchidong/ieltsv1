...
<div>
    <div class="cycle">
        ...
        <h1>5<img src="{{ asset('images/logo-kien.png') }}" style="width: 25px;"><img src="{{ asset('images/logo-kien.png') }}" style="width: 25px;">- Internal error</h1>
        ...
        <div style="text-align: center">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/6LgEfm3qIcs?rel=0&autoplay=1 "  frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
