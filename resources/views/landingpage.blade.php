                ...
                <div class="row count-content">
                    ...
                    <div class="count-form col-12 col-lg-12 col-sm-12 col-md-12" >
                        <form action="" method="post">
                            ...
                            <input type="text" class="count-input" name="phone" required placeholder="Nhập Sô điện thoại" />
            ...
            <div>
                ...
                <ol>
                    ...
                    <li>
                        ...
                        <ul >
                            <li>Thời lượng: 20 buổi (15 buổi kỹ năng + 5 buổi chuyên sâu phát âm và phản xạ nói)</li>
                ...
                <div>
                    ...
                    <ol>
                        ...
                        <li>
                            <span>THÔNG TIN KHÓA HỌC:</span>
                            <ul >
                                <li>Thời lượng: 22 buổi (17 buổi kỹ năng + 5 buổi chuyên sâu phát âm và phản xạ nói)</li>
                                <li>Thời gian: 2 buổi/ tuần; 2 giờ/ buổi; 19.00 – 21.00 các buổi tối</li>
                                <li>Địa điểm: Tòa nhà Dream house, ngõ 136 phố Chùa Láng, Hà Nội</li>
                                <li>Học phí: 4,800,000</li>
                            </ul>
            ...
            <div class="col-6 col-lg-6 col-sm-6 col-md-6" >
                ...
                <div class="form-dk">
                    <form action="" method="post">
                        ...
                        <textarea name="content" required id="" cols="15" rows="5" placeholder="Để lại lời nhắn cho chúng tôi"></textarea>
